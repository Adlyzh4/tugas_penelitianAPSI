        ...
        <div ref={ref} className="kelas-page bg-light" >
            <div className="kelas py-5 min-vh-100">
                <Container>
                    <Row className="mb-5">
                        <Col>
                            <h1 className="fw-bold text-center display-5" style={{ fontFamily: 'Poppins, sans-serif' }}>✨ Semua Menu dan Promo ✨</h1>
                    ...
                    <Row className="g-4">
                        {semuaMenu.map((menu) => (
                            <Col key={menu.id} md={6} lg={4}>
                                <div
                                    className="menu-card bg-white shadow-sm rounded-4 h-100 d-flex flex-column"
                                    style={{
